...
public final class Gradient {
	...
	public final static int ID_MAROON_TO_GOLD = 0;
	public final static int ID_BLUE_TO_RED = 1;
	public final static int ID_BLACK_TO_WHITE = 2;
	public final static int ID_RED_TO_GREEN = 3;
	public final static int ID_GREEN_YELLOW_ORANGE_RED = 4;
	public final static int ID_RAINBOW = 5;
	public final static int ID_HOT = 6;
	public final static int ID_HEAT = 7;
	public final static int ID_ROY = 8;
	public final static int ID_BLACK_TO_WHITE_RAINBOW = 9;
	public final static int ID_WHITE_TO_BLACK_RAINBOW = 10;
		  
	
	
	public static Color[] getGradient(int GradientId){
		Color[] gradient = null;
		switch(GradientId){
		case Gradient.ID_MAROON_TO_GOLD:
			gradient = Gradient.GRADIENT_MAROON_TO_GOLD;
			break;
			
		case Gradient.ID_BLACK_TO_WHITE:
			gradient = Gradient.GRADIENT_BLACK_TO_WHITE;
			break;
		
		case Gradient.ID_BLACK_TO_WHITE_RAINBOW:
			gradient = Gradient.GRADIENT_BLACK_TO_WHITE_RAINBOW;
			break;
		
		case Gradient.ID_BLUE_TO_RED:
			gradient = Gradient.GRADIENT_BLUE_TO_RED;
			break;
	
		case Gradient.ID_GREEN_YELLOW_ORANGE_RED:
			gradient = Gradient.GRADIENT_GREEN_YELLOW_ORANGE_RED;
			break;

		case Gradient.ID_HEAT:
			gradient = Gradient.GRADIENT_HEAT;
			break;
		
		case Gradient.ID_HOT:
			gradient = Gradient.GRADIENT_HOT;
			break;
		
		case Gradient.ID_RAINBOW:
			gradient = Gradient.GRADIENT_RAINBOW;
			break;
		
		case Gradient.ID_RED_TO_GREEN:
			gradient = Gradient.GRADIENT_RED_TO_GREEN;
			break;
		
		case Gradient.ID_ROY:
			gradient = Gradient.GRADIENT_ROY;
			break;
		
		case Gradient.ID_WHITE_TO_BLACK_RAINBOW:
			gradient = Gradient.GRADIENT_WHITE_TO_BLACK_RAINBOW;
			break;
  ...
  /**
   * Produces a gradient through the rainbow.  Starting at white and ending in black, with all the colors of the rainbow in between 
   */
  public final static Color[] GRADIENT_BLACK_TO_WHITE_RAINBOW = createMultiGradient(
      new Color[] { Color.white, new Color(181, 32, 255), Color.blue, Color.green,
          Color.yellow, Color.orange, Color.red, Color.black }, 500);
  
  
  /**
   * Produces a gradient through the rainbow.  Starting at white and ending in black, with all the colors of the rainbow in between 
   */
  public final static Color[] GRADIENT_WHITE_TO_BLACK_RAINBOW = createMultiGradient(
      new Color[] { Color.BLACK, new Color(181, 32, 255), Color.blue, Color.green,
          Color.yellow, Color.orange, Color.red, Color.WHITE }, 500);
